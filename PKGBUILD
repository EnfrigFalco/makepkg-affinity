...
pkgname=wine-git
pkgver=8.7.r0.gffe889e4b89
pkgrel=1
pkgdesc='A compatibility layer for running Windows programs (git version with Affinity patches)'
arch=('x86_64')
...
replaces=('bin32-wine')
source=('git+https://gitlab.winehq.org/ElementalWarrior/wine.git#branch=affinity-photo2-wine87'
